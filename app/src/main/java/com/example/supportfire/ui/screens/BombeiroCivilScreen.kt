...
@Composable
fun BombeiroCivilScreen(onNavigateToRegistration: (String) -> Unit) {
    ...
    Column(
        ...
        Text(
            text = "Aqui vai a descrição completa sobre o curso de Bombeiro Profissional Civil. Fale sobre a carga horária, os módulos, pré-requisitos, e o mercado de trabalho. Detalhe tudo que o aluno aprenderá.",
            fontSize = 18.sp,
